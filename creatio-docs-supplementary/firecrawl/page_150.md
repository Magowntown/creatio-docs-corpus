...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/administration/logging-tools/audit-log/set-up-the-audit-log#__docusaurus_skipToContent_fallback)
...
The **change log** records changes to business data. You can use it to track product price or account balance changes. Learn more: [Set up the change log](https://academy.creatio.com/documents?id=258).
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/administration/logging-tools/audit-log/set-up-the-audit-log\#see-also "Direct link to See also")

[View and archive the audit log](https://academy.creatio.com/documents?id=2320)

* * *

## Resources [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/administration/logging-tools/audit-log/set-up-the-audit-log\#resources "Direct link to Resources")
...
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/administration/logging-tools/audit-log/set-up-the-audit-log#see-also)
- [Resources](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/administration/logging-tools/audit-log/set-up-the-audit-log#resources)