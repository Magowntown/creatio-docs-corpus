...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log#__docusaurus_skipToContent_fallback)
...
## Method 1. Set up logging in the \[Change log\] section [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log\#title-234-1 "Direct link to Method 1. Set up logging in the [Change log] section")
...
## Method 2. Set up logging in a Classic UI section, lookup or detail [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log\#title-234-2 "Direct link to Method 2. Set up logging in a Classic UI section, lookup or detail")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log\#see-also "Direct link to See also")
...
- [Method 1. Set up logging in the \[Change log\] section](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log#title-234-1)
- [Method 2. Set up logging in a Classic UI section, lookup or detail](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log#title-234-2)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/set-up-the-change-log#see-also)