...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration#__docusaurus_skipToContent_fallback)
...
**AWS S3 (Simple Storage Service)** is a data transfer protocol developed by Amazon. Learn more: [official vendor documentation](https://docs.aws.amazon.com/s3/index.html?nc2=h_ql_doc_s3).

Important

Creatio officially supports and guarantees compatibility with AWS S3 only.
Other third-party storage solutions marketed as "S3-compatible" or "S3-like" may function with Creatio, however, such integrations are not certified or guaranteed by Creatio. Use of non-AWS S3-compatible services is at the customer’s sole discretion.
...
If you use Creatio **in the cloud**, contact [Creatio support](mailto:support@creatio.com) to integrate an AWS S3 file storage.

To integrate an AWS S3 file storage to Creatio **on-site**:

1. Setup in AWS S3. [Read more >>>](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration#title-3428-1)
2. Setup in Creatio. [Read more >>>](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration#title-3428-2)

## Setup in AWS S3 [​](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration\#title-3428-1 "Direct link to Setup in AWS S3")
...
## Setup in Creatio [​](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration\#title-3428-2 "Direct link to Setup in Creatio")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration\#see-also "Direct link to See also")
...
- [Setup in AWS S3](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration#title-3428-1)
- [Setup in Creatio](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration#title-3428-2)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/deployment-additional-setup/file-storage/set-up-s3-file-storage-integration#see-also)