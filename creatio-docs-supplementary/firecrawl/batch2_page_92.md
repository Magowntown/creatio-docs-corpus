...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log#__docusaurus_skipToContent_fallback)
...
## Access the audit log [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log\#title-235-1 "Direct link to Access the audit log")
...
Configure the balancer to make the audit log display the user IP addresses in Creatio .NET Core or .NET 6 deployed on-site with horizontal scaling. Learn more: [Set up the IP addresses in the audit log for .NET Core and .NET 6](https://academy.creatio.com/documents?id=2110#title-2491-19).
...
## Archive the audit log [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log\#title-235-4 "Direct link to Archive the audit log")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log\#see-also "Direct link to See also")

[Set up the audit log](https://academy.creatio.com/documents?id=1260)

- [Access the audit log](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log#title-235-1)
- [Archive the audit log](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log#title-235-4)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/logging-tools/audit-log/view-and-archive-the-audit-log#see-also)