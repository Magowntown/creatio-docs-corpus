...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/deployment_additional_setup/sase_resolution_notifications#__docusaurus_skipToContent_fallback)
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/deployment_additional_setup/sase_resolution_notifications\#see-also "Direct link to See also")

[Case resolution notification setup](https://academy.creatio.com/documents?product=service%20enterprise&ver=7&id=1786)

- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/deployment_additional_setup/sase_resolution_notifications#see-also)