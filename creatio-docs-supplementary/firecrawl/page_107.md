...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#__docusaurus_skipToContent_fallback)
...
## Method 1. Deploy Creatio .NET Core on Linux directly [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-1 "Direct link to Method 1. Deploy Creatio .NET Core on Linux directly")

To deploy the Creatio application server:

- Install .NET Core, a GDI+ compatible API for non-Windows operating systems, and development libraries and header files for GNU C. [Read more >>>](https://academy.creatio.com/documents?id=2124)
- Run the Creatio application server. [Read more >>>](https://academy.creatio.com/documents?id=2125)

### Install .NET Core and other Creaito dependencies [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-2 "Direct link to Install .NET Core and other Creaito dependencies")
...
### Run the Creatio application server [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-3 "Direct link to Run the Creatio application server")
...
## Method 2. Deploy Creatio .NET Core on Linux using Docker [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-4 "Direct link to Method 2. Deploy Creatio .NET Core on Linux using Docker")
...
### Configure the Creatio caching server (Redis) [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-5 "Direct link to Configure the Creatio caching server (Redis)")
...
### Install Docker [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-6 "Direct link to Install Docker")
...
#### Create a Dockerfile [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-7 "Direct link to Create a Dockerfile")
...
#### Build and run a Docker image [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-247-8 "Direct link to Build and run a Docker image")
...
## Configure Creatio .NET Core for HTTPS [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#title-2497-17 "Direct link to Configure Creatio .NET Core for HTTPS")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux\#see-also "Direct link to See also")
...
- [Method 1. Deploy Creatio .NET Core on Linux directly](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-247-1)
  - [Install .NET Core and other Creaito dependencies](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-247-2)
  - [Run the Creatio application server](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-247-3)
- [Method 2. Deploy Creatio .NET Core on Linux using Docker](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-247-4)
  - [Configure the Creatio caching server (Redis)](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-247-5)
  - [Install Docker](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-247-6)
- [Configure Creatio .NET Core for HTTPS](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#title-2497-17)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net_core_server/deploy_the_creatio_net_core_application_on_linux#see-also)