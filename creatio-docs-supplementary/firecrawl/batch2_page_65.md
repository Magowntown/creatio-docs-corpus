...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication#__docusaurus_skipToContent_fallback)
...
## Set up user authentication through LDAP on .NET Framework [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication\#title-2020-24 "Direct link to Set up user authentication through LDAP on .NET Framework")
...
## Set up user authentication through LDAP on .NET Core or .NET 6 [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication\#title-2020-25 "Direct link to Set up user authentication through LDAP on .NET Core or .NET 6")
...
## Set up the authentication providers [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication\#title-2020-26 "Direct link to Set up the authentication providers")
...
## Set up the domain authentication [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication\#title-2020-27 "Direct link to Set up the domain authentication")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication\#see-also "Direct link to See also")
...
- [Set up user authentication through LDAP on .NET Framework](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication#title-2020-24)
- [Set up user authentication through LDAP on .NET Core or .NET 6](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication#title-2020-25)
- [Set up the authentication providers](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication#title-2020-26)
- [Set up the domain authentication](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication#title-2020-27)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/synchronize-users-with-ldap/set-up-ldap-authentication#see-also)