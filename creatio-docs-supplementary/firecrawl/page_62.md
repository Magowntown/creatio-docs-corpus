...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#__docusaurus_skipToContent_fallback)
...
## Prepare the setup files [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux\#title-263-1 "Direct link to Prepare the setup files")
...
## Set up ConnectionStrings.config [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux\#title-263-2 "Direct link to Set up ConnectionStrings.config")
...
### Edit the ConnectionStrings.config file [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux\#title-263-5 "Direct link to Edit the ConnectionStrings.config file")
...
### Required ConnectionStrings.config settings [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux\#title-263-6 "Direct link to Required ConnectionStrings.config settings")
...
### Optional ConnectionStrings.config settings [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux\#title-263-7 "Direct link to Optional ConnectionStrings.config settings")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux\#see-also "Direct link to See also")
...
- [Prepare the setup files](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#title-263-1)
- [Set up ConnectionStrings.config](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#title-263-2)
  - [Edit the ConnectionStrings.config file](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#title-263-5)
  - [Required ConnectionStrings.config settings](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#title-263-6)
  - [Optional ConnectionStrings.config settings](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#title-263-7)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_linux/net6_server/prepare_creatio_net6_setup_files_on_linux#see-also)