...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets#__docusaurus_skipToContent_fallback)
...
## Check WebSocket settings for Windows Server 2016 [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets\#title-271-1 "Direct link to Check WebSocket settings for Windows Server 2016")
...
## WebSocket setup FAQ [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets\#title-271-4 "Direct link to WebSocket setup FAQ")

### How can I make sure the WebSockets are set up correctly? [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets\#title-271-5 "Direct link to How can I make sure the WebSockets are set up correctly?")
...
Learn more about business process elements in a separate guide: [Process elements reference](https://academy.creatio.com/docs/user/bpm_tools/process_elements_reference).

### I set up WebSockets, but they will not work. Why? [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets\#title-271-6 "Direct link to I set up WebSockets, but they will not work. Why?")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets\#see-also "Direct link to See also")
...
- [Check WebSocket settings for Windows Server 2016](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets#title-271-1)
- [WebSocket setup FAQ](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets#title-271-4)
  - [How can I make sure the WebSockets are set up correctly?](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets#title-271-5)
  - [I set up WebSockets, but they will not work. Why?](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets#title-271-6)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/application_server_on_windows/set_up_websockets#see-also)