...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements#__docusaurus_skipToContent_fallback)
...
## General guidelines [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements\#title-265-1 "Direct link to General guidelines")
...
## Connection channels [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements\#title-265-2 "Direct link to Connection channels")
...
## Requirements to servers for the Exchange Listener synchronization service [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements\#title-265-3 "Direct link to Requirements to servers for the Exchange Listener synchronization service")
...
## Software requirements [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements\#title-265-4 "Direct link to Software requirements")
...
| Database server (Windows) | Windows Server 2016 and later<br>Microsoft SQL 2016 and later, or<br>Oracle 11g and later, or<br>PostgreSQL 16 and later |
| Database server (Linux) | Linux Debian 11<br>PostgreSQL 16 and later |
| Caching server | Linux Debian 11;<br>Redis Server 6.4 and later |
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements\#see-also "Direct link to See also")

[Set up Creatio caching server](https://academy.creatio.com/documents?product=administration&ver=7&id=2108)

[Redis Sentinel](https://academy.creatio.com/documents?id=1947)
...
- [General guidelines](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements#title-265-1)
- [Connection channels](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements#title-265-2)
- [Requirements to servers for the Exchange Listener synchronization service](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements#title-265-3)
- [Software requirements](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements#title-265-4)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.0/on-site-deployment/system_requirements/server-side_system_requirements#see-also)