...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#__docusaurus_skipToContent_fallback)
...
## User account blocking principles [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user\#title-2108-5 "Direct link to User account blocking principles")
...
## Specify the user account blocking conditions [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user\#title-2108-1 "Direct link to Specify the user account blocking conditions")

### Set the number of login attempts [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user\#title-2108-3 "Direct link to Set the number of login attempts")
...
### Set up the user lockout period [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user\#title-2108-4 "Direct link to Set up the user lockout period")
...
## Unblock a user account [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user\#title-2108-2 "Direct link to Unblock a user account")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user\#see-also "Direct link to See also")

[Description of system settings](https://academy.creatio.com/documents?id=1259)

- [User account blocking principles](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#title-2108-5)
- [Specify the user account blocking conditions](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#title-2108-1)
  - [Set the number of login attempts](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#title-2108-3)
  - [Set up the user lockout period](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#title-2108-4)
- [Unblock a user account](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#title-2108-2)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/unblock-a-user#see-also)