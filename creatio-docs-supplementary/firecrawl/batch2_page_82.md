...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/clear-the-change-log#__docusaurus_skipToContent_fallback)
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/clear-the-change-log\#see-also "Direct link to See also")

[Set up the audit log](https://academy.creatio.com/documents?id=1260)

- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/logging-tools/change-log/clear-the-change-log#see-also)