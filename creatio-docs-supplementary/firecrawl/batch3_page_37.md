...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#__docusaurus_skipToContent_fallback)
...
1. **Prepare the file for import** and fill out the needed columns. Learn more: [Prepare an Excel file for importing users](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#title-296-1).
2. Download the file and **import users** to the system. Learn more: [Run the import process](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#title-296-2).
3. **Set up user records**: assign roles, specify passwords and available licenses. Learn more: [Set password, role, and grant licenses to the imported users](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#title-296-3).

## Prepare an Excel file for importing users [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel\#title-296-1 "Direct link to Prepare an Excel file for importing users")
...
## Run the import process [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel\#title-296-2 "Direct link to Run the import process")
...
## Set password, role, and grant licenses to the imported users [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel\#title-296-3 "Direct link to Set password, role, and grant licenses to the imported users")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel\#see-also "Direct link to See also")
...
- [Prepare an Excel file for importing users](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#title-296-1)
- [Run the import process](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#title-296-2)
- [Set password, role, and grant licenses to the imported users](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#title-296-3)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/administration/user-and-access-management/user-management/import-users-from-excel#see-also)