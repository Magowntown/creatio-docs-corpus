...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication#__docusaurus_skipToContent_fallback)
...
- IIS server setup that activates authentication using the NTLM protocol. Learn more: [Set up the Windows authentication on IIS](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication#title-306-1).
...
## Set up the Windows authentication on IIS [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication\#title-306-1 "Direct link to Set up the Windows authentication on IIS")
...
## Set up the Web.config file of the loader application [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication\#title-306-2 "Direct link to Set up the Web.config file of the loader application")
...
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication\#see-also "Direct link to See also")

[Windows authentication](internal:#XREF_43633_NTLM)

[How Windows authentication works](internal:#XREF_36524__NTLM)

- [Set up the Windows authentication on IIS](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication#title-306-1)
- [Set up the Web.config file of the loader application](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication#title-306-2)
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.1/administration/user-and-access-management/authentication/windows-authentication#see-also)