...
[Skip to main content](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#__docusaurus_skipToContent_fallback)
...
For up-to-date documentation, see the **[latest version](https://academy.creatio.com/docs/8.x/setup-and-administration/on-site-deployment/containerized-components/global-search)** (8.3).
...
You need repository access to set up the current version of the global search service. Contact [Creatio support](https://academy.creatio.commailto:support@creatio.com/) to verify your license and gain access to the repository.

## Set up the global search service using Kubernetes [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-30 "Direct link to Set up the global search service using Kubernetes")

To set up the service, download the source files. [Download files](https://d3a7ykdi65m4cy.cloudfront.net/ac-en/s3fs-public/downloads/global_search/globalsearch-5.0.24.tgz_.zip).
...
For highly loaded environments, we recommend deploying ElasticSearch in a cluster. Learn more in [ElasticSearch documentation](https://www.elastic.co/guide/en/elasticsearch/reference/7.16/setup.html).
...
## Set up the global search service in Docker [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-19 "Direct link to Set up the global search service in Docker")
...
The procedure below is relevant for global search service version 3.0. If you need to set up an earlier version of the global search, follow the procedure described in [Creatio 7.16 documentation](https://academy.creatio.com/documents/administration/7-16/set-global-search).
...
### Global search components [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-20 "Direct link to Global search components")
...
To set up the components, download the source files. [Download files](https://github.com/Advance-Technologies-Foundation/gs-docker-compose/archive/refs/tags/v6.0.11.zip).
...
### Global search setup procedure [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-21 "Direct link to Global search setup procedure")
...
#### Install Docker [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-22 "Direct link to Install Docker")
...
#### Install Docker-Compose [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-23 "Direct link to Install Docker-Compose")

The installation of Docker-Compose is covered in the [Docker documentation](https://docs.docker.com/compose/install/).

#### Install ElasticSearch [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-24 "Direct link to Install ElasticSearch")

note

This guide covers the procedure for deploying ElasticSearch in Docker-Compose. You can also deploy ElasticSearch as OS daemon, which does not involve installing Docker and Docker-Compose. Learn more about the setup procedure in the [ElasticSearch documentation](https://www.elastic.co/guide/en/elasticsearch/reference/5.6/docker.html).

To install ElasticSearch:

1. Go to the ElasticSearch installation server (server 1) and open the /opt directory.

2. Download and unpack the archive with setup files to the directory. [Download the archive](https://github.com/Advance-Technologies-Foundation/gs-docker-compose/archive/refs/tags/v6.0.11.zip).
...
#### Set up the container variables [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-25 "Direct link to Set up the container variables")
...
To check the external IP address of the server, run the `hostname -I | awk '{ print $1 }'` command.
...
### Run containers that have Global Search Service components [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-26 "Direct link to Run containers that have Global Search Service components")
...
2. Download and unpack the archive with setup files to the opened folder. [Download the archive](https://github.com/Advance-Technologies-Foundation/gs-docker-compose/archive/refs/tags/v6.0.11.zip).
...
#### Verify that containers ran successfully [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-27 "Direct link to Verify that containers ran successfully")
...
#### Logging [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-12 "Direct link to Logging")
...
The mysql or rabbitmq containers might become temporarily unavailable on start because they run after the rest of the containers. In this case, wait until a notification about the successful container connection and start appears in the log files: "Now listening on: http:/ **::** 80 Application started. Press Ctrl+C to shut down."

## Connect the global search service to Creatio [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-29 "Direct link to Connect the global search service to Creatio")

### Actions on the server [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-14 "Direct link to Actions on the server")
...
5. **GS\_WEB\_API\_URL** (only for Kubernetes): the IP address of the Linux server where the global search components are deployed.
...
4. **GS\_WEB\_API\_URL** (only for Kubernetes): the IP address of the Linux server where the global search components are deployed.
...
For Docker: `curl -v -X POST -d '{"templateName": "default.json"}' -H "Content-Type: application/json" http://[SERVER2_IP_ADDRESS]:81/sites/my-test-site/search`

For Kubernetes: `curl -v -X POST -d '{"templateName": "default.json"}' -H "Content-Type: application/json" http://[GS_WEB_API_URL]/sites/my-test-site/search`
...
### Settings in Creatio for Microsoft SQL DBMS [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-15 "Direct link to Settings in Creatio for Microsoft SQL DBMS")
...
### Settings in Creatio for Oracle DBMS [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-16 "Direct link to Settings in Creatio for Oracle DBMS")
...
### Settings in Creatio for PostgreSQL DBMS [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#title-254-33 "Direct link to Settings in Creatio for PostgreSQL DBMS")
...
* * *\
\
## See also [​](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search\#see-also "Direct link to See also")\
\
...
\
- [Set up the global search service using Kubernetes](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-30)\
- [Set up the global search service in Docker](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-19)\
  - [Global search components](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-20)\
  - [Global search setup procedure](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-21)\
  - [Run containers that have Global Search Service components](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-26)\
- [Connect the global search service to Creatio](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-29)\
  - [Actions on the server](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-14)\
  - [Settings in Creatio for Microsoft SQL DBMS](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-15)\
  - [Settings in Creatio for Oracle DBMS](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-16)\
  - [Settings in Creatio for PostgreSQL DBMS](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#title-254-33)\
- [See also](https://academy.creatio.com/docs/8.x/setup-and-administration/8.2/on-site-deployment/containerized-components/global-search#see-also)