...
> **2026-09-11 ACTIVE (non-Pampa) - Business Central Integration `IWMSDynamicsBCIntegration` = build 344 / V167 shipped on mkpdev-2153; D4 ahead at V171 (readability pass + Reconciliation tab + designer gate), ships as 345** (`~/creatio-hub/reference/bc-connector/`, README row 52). The exact archive is live on D4, `mkpdev-2153`, `mkpdev-interweave`, and JMT. It carries 15 flows / 243 mappings, 18 rules, 18 Knowledge Base articles, 20 Creatio.ai tools, stable Needs-attention links, posted-document hold guidance, and record guidance across all seven affected forms. 2153 suite 9/9; JMT grammar 19/19; JMT schedules remain off. Current truth and remaining owner gates: `BC_CONNECTOR_BUILD338_V161_FINAL_VERIFICATION_2026-09-08.md`.
>
