-- BGSalesByItemView ORIGINAL (Before Employee JOIN Fix)
-- Problem: JOIN Employee e ON (sg."Id" = e."BGSalesGroupLookupId") joins ALL employees in sales group
-- This causes 26x duplicate rows per order line (one for each employee in the sales group)
-- Archived: 2026-01-29

CREATE OR REPLACE VIEW "BGSalesByItemView" AS
SELECT
  o."Id",
  o."CreatedOn",
  o."CreatedById",
...
FROM
  ...
  JOIN "Employee" e ON ((sg."Id" = e."BGSalesGroupLookupId")))  -- ⚠️ BUG: Joins ALL employees in group
