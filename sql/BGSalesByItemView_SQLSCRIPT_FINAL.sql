-- BGSalesByItemView SqlScript
-- Package: PampaBay
--
-- FIXES INCLUDED:
-- 1. BGProductDescription column added (RPT-006)
-- 2. Employee JOIN fixed - uses Order.BGSalesRepLookupId instead of SalesGroup (RPT-007)
--    This eliminates 26x duplicate rows per order line
--
-- Updated: 2026-01-30
