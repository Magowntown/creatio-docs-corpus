#!/usr/bin/env python3
"""
Save UsrExcelReportService code via Creatio API
"""
...
def main():
    ...
    # Get current schema
    print("\n=== Getting UsrExcelReportService schema ===")
    ...
    if response.status_code == 200:
        ...
        # Try to save using SaveSchema
        print("\n=== Saving schema ===")
        save_url = f"{CREATIO_URL}/0/ServiceModel/SourceCodeDesignerService.svc/SaveSchema"
        ...
        response = session.post(save_url, json=save_data, headers=headers, timeout=120)
