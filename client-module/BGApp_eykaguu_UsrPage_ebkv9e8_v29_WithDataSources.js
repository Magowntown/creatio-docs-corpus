/**
 * UsrPage_ebkv9e8 - v29 WITH DATA SOURCES
 * Package: BGApp_eykaguu
 *
 * CHANGES FROM v28:
 * - Hides parent's iframe container (GridContainer_fh039aq, UsrIframe)
 * - Configures data sources for YearMonth and SalesGroup ComboBoxes
 */
define("UsrPage_ebkv9e8", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
    ...
    return {
        viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
            ...
            // Hide parent's UsrIframe element
            {
                "operation": "merge",
                "name": "UsrIframe",
                "values": { "visible": false }
            ...
            // Year-Month ComboBox with lookup binding
            {
                "operation": "insert",
            ...
            // Sales Group ComboBox with lookup binding
            {
                "operation": "insert",
        ...
        viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/{
            "attributes": {
                ...
                "UsrYearMonth": {
                    "modelConfig": {
                        "path": "UsrYearMonthDS.BGYearMonth"
                    }
                },
                "UsrSalesGroup": {
                    "modelConfig": {
                        "path": "UsrSalesGroupDS.BGSalesGroup"
                    }
                },
        ...
        handlers: /**SCHEMA_HANDLERS*/[
            // Page init
            {
                ...
                handler: async (request, next) => {
                    ...
                    console.log("[v29] Page initialized");
                    return;
                }
            },
                ...
                handler: async (request, next) => {
                    if (request.attributeName === "LookupAttribute_bsixu8a" && !request.silent) {
                        ...
                        try {
                            ...
                            console.log("[v29] Error getting report:", e);
                        }
            ...
            // Generate report button click
            {
                ...
                handler: async (request, next) => {
                    ...
                    console.log("[v29] Generate:", reportDisplayName, "| ID:", pampaReportId);
                    ...
                    try {
                        ...
                        if (metaResp.ok) {
                            ...
                            console.log("[v29] Report metadata | URL:", reportUrl, "| Code:", reportCode);
                        }
                    } catch (e) {
                        console.log("[v29] Error fetching report metadata:", e);
                    }

                    // LOOKER: Open in new tab
                    if (reportUrl) {
                        console.log("[v29] Opening Looker URL:", reportUrl);
                    ...
                    try {
                        ...
                        if (data.value && data.value[0]) {
                            ...
                            console.log("[v29] Found template:", data.value[0].IntName);
                        } else {
                    ...
                    if (reportLower.includes("commission")) {
                        ...
                        console.log("[v29] Commission | YearMonth:", yearMonthId, "| SalesGroup:", salesGroupId);
                        ...
                        console.log("[v29] Items by Customer | Name:", customerName);
