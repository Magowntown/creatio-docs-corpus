define("UsrPage_ebkv9e8", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			// Hide parent's report container (we use BGPampaReport instead)
			{
				"operation": "merge",
			...
			// Remove original report combo
			{
				"operation": "remove",
				"name": "ComboBox_bo00lsk"
			},
			// Hide original date range filters
			{
				"operation": "merge",
				"name": "CreatedFrom",
				"values": {
			...
			// MAKE REPORT BUTTON VISIBLE and wire to our handler
			{
				"operation": "merge",
				"name": "Button_vae0g6x",
				"values": {
			...
			// Insert main report selection container
			{
				"operation": "insert",
			...
			// Report lookup field
			{
				...
				"parentName": "ReportSelectionContainer",
				"propertyName": "items",
				"index": 0
			},
			...
			// Year-Month field
			{
				...
				"parentName": "FilterFieldsContainer",
				"propertyName": "items",
				"index": 0
			},
			// Sales Group field
			...
			// Warning label for date info
			{
				"operation": "insert",
				"name": "WarningLabel",
				"values": {
					"type": "crt.Label",
					"caption": "Date and transaction information is derived from QuickBooks synced data.",
