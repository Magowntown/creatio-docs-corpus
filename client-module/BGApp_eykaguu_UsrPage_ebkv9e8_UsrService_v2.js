define("UsrPage_ebkv9e8", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
    return {
        ...
        handlers: /**SCHEMA_HANDLERS*/[
            ...
            // Report generation handler - resolves IntExcelReport then calls UsrExcelReportService
            {
                request: "usr.GenerateExcelReportRequest",
                handler: async (request, next) => {
                    ...
                    // Fetch report metadata from UsrReportesPampa to get name/code
                    try {
                    ...
                    // Resolve to IntExcelReport by name (CRITICAL STEP)
                    ...
                    // Call UsrExcelReportService with the resolved IntExcelReport ID
                    try {
