define("UsrPage_ebkv9e8", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			// HYBRID VERSION: Only report generation handler
			// NO framework interceptors (crt.LoadDataRequest, crt.HandleViewModelAttributeChangeRequest)
			// This ensures ZERO interference with QB sync or any other system processes
			{
				request: "usr.GenerateExcelReportRequest",
