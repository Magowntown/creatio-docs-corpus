/**
 * UsrPage_ebkv9e8 - v31 USE PARENT DROPDOWN
 * Package: BGApp_eykaguu
 *
 * APPROACH:
 * - Keep parent's report dropdown visible (don't hide GridContainer_oshnwh8)
 * - Only hide parent's iframe container (GridContainer_fh039aq)
 * - Add Commission filters (YearMonth, SalesGroup)
 * - Add Customer Name input
 * - Listen to parent's LookupAttribute_bsixu8a for filter visibility
 */
define("UsrPage_ebkv9e8", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
    ...
    return {
        viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
            // DO NOT hide parent's report dropdown - let it work
            // {
            //     "operation": "merge",
            ...
            // Commission Filters Container - insert after parent's dropdown
            {
                "operation": "insert",
        ...
        handlers: /**SCHEMA_HANDLERS*/[
            // Page init
            {
                ...
                handler: async (request, next) => {
                    ...
                    console.log("[v31] Page initialized");
                    return;
                }
            },

            // Report selection - listen to parent's attribute
            {
                ...
                handler: async (request, next) => {
                    if (request.attributeName === "LookupAttribute_bsixu8a" && !request.silent) {
                        ...
                        try {
                            ...
                            console.log("[v31] Error getting report:", e);
                        }
            ...
            // Generate report
            {
                ...
                handler: async (request, next) => {
                    ...
                    console.log("[v31] Generate:", reportDisplayName, "| ID:", pampaReportId);
                    ...
                    try {
                        ...
                        if (data.value && data.value[0]) {
                            ...
                            console.log("[v31] Found template:", data.value[0].IntName);
                        } else {
                    ...
                    if (reportLower.includes("commission")) {
                        ...
                        console.log("[v31] Commission | YearMonth:", yearMonthId, "| SalesGroup:", salesGroupId);
                        ...
                        console.log("[v31] Items by Customer | Name:", customerName);
