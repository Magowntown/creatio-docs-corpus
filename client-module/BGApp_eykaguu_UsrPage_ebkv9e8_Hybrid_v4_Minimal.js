/**
 * UsrPage_ebkv9e8 - Hybrid Handler v4 (Minimal/Non-Destructive)
 *
 ...
 *
 * Changes from v2/v3:
 * - NO removal of GridContainer_knkow5v (Status filter)
 * - NO removal of ComboBox_8w0dlcf (Status dropdown)
 * - NO hiding of date filters
 * - Uses ORIGINAL report selector (LookupAttribute_0as4io2)
 * - Only inserts Commission-specific filters conditionally
 */
define("UsrPage_ebkv9e8", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
    return {
        viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
            ...
            // Year-Month filter (Commission only)
            {
                "operation": "insert",
                "name": "BGYearMonth",
                "values": {
                    ...
                    "label": "Year-Month",
                    "labelPosition": "auto",
                    "control": "$LookupAttribute_YearMonth",
                    "listActions": [],
            ...
            // Sales Group filter (Commission only)
            {
                "operation": "insert",
                "name": "BGSalesGroup",
                "values": {
                    ...
                    "label": "Sales Group",
                    "labelPosition": "auto",
                    "control": "$LookupAttribute_SalesGroup",
                    "listActions": [],
                    "showValueAsLink": true,
                    "controlActions": [],
        ...
        viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
            {
                ...
                "values": {
                    ...
                    // Commission-specific lookup attributes
                    "LookupAttribute_YearMonth": {
                        "modelConfig": {
                            "path": "UsrEntity_e7ac661DS.BGYearMonth"
                        }
                    },
                    "LookupAttribute_SalesGroup": {
                        "modelConfig": {
        ...
        handlers: /**SCHEMA_HANDLERS*/[
            ...
            // Listen for the ORIGINAL report selector
            // ========================================
            {
            ...
            // ========================================
            {
                ...
                handler: async (request, next) => {
                    ...
                    // Get selected report from ORIGINAL selector
                    ...
                    if (isCommissionReport) {
                        // Commission reports use our custom filters
                        try {
                            const yearMonth = await context.LookupAttribute_YearMonth;
                        ...
                        try {
                            const salesGroup = await context.LookupAttribute_SalesGroup;
